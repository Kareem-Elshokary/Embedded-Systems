...
void DIO_PORT_DIRECTION(u8 Copy_u8portID,u8 Copy_u8PortDir )
{
...
void DIO_WRITE_PORT(u8 Copy_u8PortID,u8 Copy_u8PortVal )
...
void	DIO_PIN_DIRECTION(u8 Copy_u8PortID,u8 Copy_u8PinID,u8 Copy_u8PinDir)
{
...
/*****************************************************************************/
void    DIO_WRITE_PIN(u8 Copy_u8PortID,u8 Copy_u8PinID,u8 Copy_u8PinValue)
{
	if(Copy_u8PinID>=PIN0&&Copy_u8PinID<=PIN7)
	{
...
/*****************************************************************************/
u8 DIO_GET_PIN_VAL(u8 copy_u8PortID , u8 Copy_u8PinID )
{

	volatile Local_PinVal ;
...
/*****************************************************************************/
void DIO_TOG_PIN(u8 copy_u8PortID,u8 Copy_u8PinID)
{
