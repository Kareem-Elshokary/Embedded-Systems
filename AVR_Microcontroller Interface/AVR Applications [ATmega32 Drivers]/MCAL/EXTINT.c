...
void EXTINT_voidInit(u8 copy_u8ExtNum,u8 copy_u8ControlSens)
{
	...
	case EXT0_ID :
		...
		DIO_PIN_DIRECTION(PORTD_ID,PIN2,PIN_INPUT);
		DIO_WRITE_PIN(PORTD_ID,PIN2,PIN_HIGH);
	...
	case EXT1_ID :
		...
		DIO_PIN_DIRECTION(PORTD_ID,PIN3,PIN_INPUT);
		DIO_WRITE_PIN(PORTD_ID,PIN3,PIN_HIGH);
		if(copy_u8ControlSens==FALLING_EDGE)
		{
	...
	case EXT2_ID :
		...
		DIO_PIN_DIRECTION(PORTB_ID,PIN2,PIN_INPUT);
		DIO_WRITE_PIN(PORTB_ID,PIN2,PIN_HIGH);
		if(copy_u8ControlSens==FALLING_EDGE)
		{
