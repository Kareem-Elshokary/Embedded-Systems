...
/********************************************************
 *
 * Function used to initialization the FIFO buffer
 *
 *******************************************************/
...
/***********************************************************
 *
 * Function used to add items to the buffer
 *
 ***********************************************************/
...
/********************************************************
 *
 * Function used to delete item from the buffer
 *
 *******************************************************/
...
/**************************************************************
 *
 * Function used to add new student to the database manually
 *
 **************************************************************/
...
/****************************************************************
 *
 * Function used to add student to the database from text file
 *
 ****************************************************************/
...
/********************************************************
 *
 * Function used to search for a student by its name
 *
 *******************************************************/
...
/********************************************************
 *
 * Function used to search for a student by its ID
 *
 *******************************************************/
...
/*******************************************************************
 *
 * Function used to count the no. of the students in the database
 *
 ******************************************************************/
...
/**************************************************************
 *
 * Function used to search for a student courses by its ID
 *
 **************************************************************/
fifo_status TheCourses(fifo_t* fifo)
{
	...
	for(i=0; i<fifo->count; i++){
		if( ptr_student->id == number ){
			for(j=0; j<5; j++){
				print("The course%d id: %d\n",j+1,ptr_student->course_id[j])
			}
		}
		if( ptr_student == (fifo->base + fifo->length * sizeof(Element_type)))
			ptr_student = fifo->base;
...
/********************************************************
 *
 * Function used to delete a student from the database
 *
 *******************************************************/
...
/********************************************************
 *
 * Function used to update student's info
 *
 *******************************************************/
...
/********************************************************
 *
 * Function used to print all the database
 *
 *******************************************************/
